# -*- coding: mbcs -*-
typelib_path = 'C:\\Program Files (x86)\\Microsoft Office\\Root\\VFS\\ProgramFilesCommonX86\\Microsoft Shared\\VBA\\VBA6\\VBE6EXT.OLB'
...
__all__ = [ 'Components', 'SelectedComponents',
           'vbextFileTypeProject', 'vbext_pp_none',
           'vbextFileTypeUserControl', 'vbextFileTypeRes',
           'VBComponents', 'vbext_wt_Immediate',
           'vbext_cv_ProcedureView', 'Events', 'References',
           'Reference', '_dispCommandBarControlEvents',
           'vbext_pt_HostProject', '_CodePanes', 'CommandBarEvents',
           'vbext_ct_ClassModule', '_CodePane', '_VBProjects_Old',
           'vbextFileTypeFrx', 'vbext_pt_StandAlone', '_VBComponent',
           'vbext_wt_ProjectWindow', '_LinkedWindows',
           'vbextFileTypePropertyPage', '_VBComponents_Old',
           'vbext_ws_Normal', 'Property', 'CodeModule',
           'vbext_ct_ActiveXDesigner', '_CommandBarControlEvents',
           'vbext_wt_FindReplace', '_VBComponent_Old', 'vbext_vm_Run',
           'vbext_wt_ToolWindow', 'vbext_wt_MainWindow',
           '_References', '_Windows', 'vbext_cv_FullModuleView',
           'vbext_WindowState', '_CodeModule', 'vbext_wt_Locals',
           '_Properties', 'vbext_wt_CodeWindow', 'vbextFileTypeClass',
           '_Component', 'vbext_rk_TypeLib', 'Application',
           '_dispVBProjectsEvents', 'CodePanes',
           '_dispReferencesEvents', 'vbext_wt_Find',
           'vbext_ProjectType', '_Components', 'vbext_WindowType',
           'vbext_ProjectProtection', 'vbext_ws_Minimize',
           'vbext_pk_Set', 'VBProject', 'ProjectTemplate',
           'vbextFileTypeExe', '_dispReferences_Events',
           'vbext_wt_Designer', '_dispVBComponentsEvents',
           'vbext_pk_Let', 'vbext_RefKind',
           'vbext_wt_LinkedWindowFrame', 'vbext_ws_Maximize',
           'Component', '_ProjectTemplate', 'vbext_ComponentType',
           'VBProjects', '_VBProjects', 'LinkedWindows',
           'vbext_ct_Document', '_VBProjectsEvents',
           'vbextFileTypeDesigners', 'vbext_pp_locked',
           '_ReferencesEvents', 'vbext_CodePaneview',
           'vbextFileTypeBinary', 'vbextFileTypeDocObject',
           'vbext_wt_Browser', 'vbext_wt_PropertyWindow',
           'VBComponent', 'Properties', 'vbext_ct_MSForm', 'Addins',
           'vbextFileTypeModule', '_VBComponents', '_Windows_old',
           '_VBProject_Old', 'vbext_wt_Watch', 'vbext_VBAMode',
           'vbextFileTypes', 'vbext_pk_Get', 'Windows', '_VBProject',
           'vbext_ProcKind', 'VBE', 'vbext_vm_Break',
           '_VBComponentsEvents', 'ReferencesEvents',
           'vbext_ct_StdModule', 'vbextFileTypeForm', '_AddIns',
           'vbext_pk_Proc', 'vbext_wt_Toolbox', 'Window',
           'vbext_vm_Design', 'vbext_rk_Project', 'CodePane',
           'vbextFileTypeGroupProject', 'AddIn']
